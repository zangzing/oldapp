...
@interface SlideOutController (Private) <UITableViewDataSource, UITableViewDelegate, SidebarViewControllerDelegate>
@end

@implementation SlideOutController
...
@implementation SlideOutController (Private)
...
- (void)sidebarViewController:(SidebarViewController *)sidebarViewController didSelectObject:(NSObject *)object atIndexPath:(NSIndexPath *)indexPath {
    ...
    SlideOutController *controller = [[SlideOutController alloc] init];
